...
public class Test {
   ...
   public static void main(String[] args) throws IOException {
     ...
     Util.jpg2png(image.getimage(),Constants.IMAGENAME);//original:"E://大学//OOP//大作业//Image encryption//ima//1.png"
     image=new MyImage(Constants.IMAGENAME);//"E://大学//OOP//大作业//Image encryption//ima//1.png"
     ...
     switch (flag){
       case 1:
         ...
         //解密
         MyImage image1=new MyImage(Constants.IMAGENAME);
